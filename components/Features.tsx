...
const FEATURES: Feature[] = [
  {
    ...
    body:
      "State lives in struct fields, not scattered hook calls. The type signature tells you everything about a component.",
    snippet: (
  ...
  },
  {
    ...
    title: "One command",
    body:
      "umber dev. That's it. No cargo, no wasm-pack, no trunk. Umber orchestrates everything and gets out of your way.",
    snippet: (
      <div class="mockup-code text-xs! mt-1">
          ...
          <div class="card bg-base-200 border border-base-300 sm:col-span-2 lg:col-span-1">
            <div class="card-body gap-3">
              ...
              <p class="text-sm text-base-content/70">
                No import paths. No boilerplate. Your editor's HTML tooling
